...
ActiveRecord::Schema.define(version: 2022_06_09_075244) do
  ...
  create_table "orders", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "purchase_historys_id", null: false
    t.bigint "purchase_history_id", null: false
    t.index ["purchase_history_id"], name: "index_orders_on_purchase_history_id"
    t.index ["purchase_historys_id"], name: "index_orders_on_purchase_historys_id"
  end
